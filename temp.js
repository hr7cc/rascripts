javascript:var DEBUG=true;NOBLE_GAP=100;var FORMAT='%unit% [%player%] - Sent:%sent%'; 
...
var translations = {
    ...
    el_GR: {
        'Incomings Overview': 'Î•Ï€Î¹ÏƒÎºÏŒÏ€Î·ÏƒÎ· Î•Î¹ÏƒÎµÏÏ‡ÏŒÎ¼ÎµÎ½Ï‰Î½ Î•Ï€Î¹Î¸Î­ÏƒÎµÏ‰Î½',
        Help: 'Î’Î¿Î®Î¸ÎµÎ¹Î±',
        'It seems like you have no incomings Ã°Å¸Ëœâ‚¬':
            'Î”ÎµÎ½ ÎµÏ‡ÎµÎ¹Ï‚ ÎµÎ¹ÏƒÎµÏÏ‡ÏŒÎ¼ÎµÎ½ÎµÏ‚ ÎµÏ€Î¹Î¸Î­ÏƒÎµÎ¹Ï‚',
        'Total Incomings:': 'Î£Ï…Î½Î¿Î»Î¹ÎºÎ­Ï‚ Î•Î¹ÏƒÎµÏÏ‡ÏŒÎ¼ÎµÎ½ÎµÏ‚:',
        'Attacking Players:': 'Î•Ï€Î¹Ï„Î¹Î¸Î­Î¼ÎµÎ½Î¿Î¹ Î Î±Î¯ÎºÏ„ÎµÏ‚:',
        'Total Attacking Players:': 'Î£ÏÎ½Î¿Î»Î¿ Î•Ï€Î¹Ï„Î¹Î¸Î­Î¼ÎµÎ½Ï‰Î½ Î Î±Î¹ÎºÏ„ÏŽÎ½:',
        'Destination Villages Count:': 'Î‘ÏÎ¹Î¸Î¼ÏŒÏ‚ Î§Ï‰ÏÎ¹ÏŽÎ½ Î ÏÎ¿Î¿ÏÎ¹ÏƒÎ¼Î¿Ï:',
        'Origin Villages Count:': 'Î‘ÏÎ¹Î¸Î¼ÏŒÏ‚ Î§Ï‰ÏÎ¹ÏŽÎ½ Î ÏÎ¿Î­Î»ÎµÏ…ÏƒÎ·Ï‚:',
        'Destination Villages': 'Î ÏÎ¿Î¿ÏÎ¹ÏƒÎ¼ÏŒÏ‚ Î•Ï€Î¹Î¸Î­ÏƒÎµÏ‰Î½',
        'Origin Villages': 'Î ÏÎ¿Î­Î»ÎµÏ…ÏƒÎ· Î•Ï€Î¹Î¸Î­ÏƒÎµÏ‰Î½',
        'Export Incomings Data': 'Î•Î¾Î±Î³Ï‰Î³Î® Î”ÎµÎ´Î¿Î¼Î­Î½Ï‰Î½',
        'Highlight Possible Nobles': 'Highlight Î Î¹Î¸Î±Î½Î¿ÏÏ‚ Î†ÏÎ¹ÏƒÏ„Î¿Ï…Ï‚',
        Village: 'Î§Ï‰ÏÎ¹ÏŒ',
        Count: 'ÎÎ¿ÏÎ¼ÎµÏÎ¿',
        'Toggle Combinations': 'Î£Ï…Î½Î´Ï…Î±ÏƒÏ„Î¹ÎºÎ® Î ÏÎ¿Î²Î¿Î»Î®',
        'Possible nobles are highlighted!':
            'Î Î¹Î¸Î±Î½Î¿Î¯ Î‘ÏÎ¹ÏƒÏ„Î¿Î¹ ÎµÎ¹Î½Î±Î¹ highlighted!',
        'No possible nobles were found!': 'Î”ÎµÎ½ Î²ÏÎ­Î¸Î·ÎºÎ±Î½ Ï€Î¹Î¸Î±Î½Î¿Î¯ Î‘ÏÎ¹ÏƒÏ„Î¿Î¹!',
        Watchtower: 'Î Î±ÏÎ±Ï„Î·ÏÎ·Ï„Î·ÏÎ¹Î¿',
        'Attack:': 'Î•Ï€Î¯Î¸ÎµÏƒÎ·:',
        'Small Attack:': 'ÎœÎ¹ÎºÏÎ® Î•Ï€Î¯Î¸ÎµÏƒÎ·:',
        'Medium Attack:': 'ÎœÎµÏƒÎ±Î¯Î± Î•Ï€Î¯Î¸ÎµÏƒÎ·:',
        'Large Attack:': 'ÎœÎµÎ³Î¬Î»Î· Î•Ï€Î¯Î¸ÎµÏƒÎ·:',
        'Destination Villages List': 'Î›Î¯ÏƒÏ„Î± Î§Ï‰ÏÎ¹ÏŽÎ½ Î ÏÎ¿Î¿ÏÎ¹ÏƒÎ¼Î¿Ï',
        'Destination Villages Coords': 'Î£Ï…Î½Ï„ÎµÏ„Î±Î³Î¼Î­Î½ÎµÏ‚ Î§Ï‰ÏÎ¹ÏŽÎ½ Î ÏÎ¿Î¿ÏÎ¹ÏƒÎ¼Î¿Ï',
        'Origin Villages List': 'Î›Î¯ÏƒÏ„Î± Î§Ï‰ÏÎ¹ÏŽÎ½ Î ÏÎ¿Î­Î»ÎµÏ…ÏƒÎ·Ï‚',
        'Origin Villages Coords': 'Î£Ï…Î½Ï„ÎµÏ„Î±Î³Î¼Î­Î½ÎµÏ‚ Î§Ï‰ÏÎ¹ÏŽÎ½ Î ÏÎ¿Î­Î»ÎµÏ…ÏƒÎ·Ï‚',
        'Last updated at:': 'Î¤ÎµÎ»ÎµÏ…Ï„Î±Î¯Î± ÎµÎ½Î·Î¼ÎµÏÏŽÎ¸Î·ÎºÎµ ÏƒÏ„Î¹Ï‚:',
        'Mass Tag Incomings': 'ÎœÎ±Î¶Î¹ÎºÎ® ÎœÎµÏ„Î¿Î½Î¿Î¼Î±ÏƒÎ¯Î±',
        'Tagging incomings ...': 'ÎœÎµÏ„Î¿Î½Î¿Î¼Î¬Î¶ÎµÎ¹ Î•Î¹ÏƒÎµÏÏ‡ÏŒÎ¼ÎµÎ½ÎµÏ‚ Î•Ï€Î¹Î¸Î­ÏƒÎµÎ¹Ï‚ ...',
        'Watchtower Timer': 'Î§ÏÏŒÎ½Î¿Ï‚ Î Î±ÏÎ±Ï„Î·ÏÎ·Ï„Î·ÏÎ¯Î¿Ï…',
        'Watchtower Timer script initialized ...':
            'Î¤Î¿ script Ï„Î¿Ï… Î Î±ÏÎ±Ï„Î·ÏÎ·Ï„Î®ÏÎ¹Î¿Ï… Î¬ÏÏ‡Î¹ÏƒÎµ ...',
        'Current world does not support watchtower!':
            'ÎŸ ÎºÏŒÏƒÎ¼Î¿Ï‚ Î´ÎµÎ½ ÎµÏ‡ÎµÎ¹ Ï€Î±ÏÎ±Ï„Î·ÏÎ·Ï„Î®ÏÎ¹Î±!',
        'Watchtower Timer script is already initialized!':
            'Î¤Î¿ script Ï„Î¿Ï… Î Î±ÏÎ±Ï„Î·ÏÎ·Ï„Î·ÏÎ¯Î¿Ï… Ï„ÏÎ­Ï‡ÎµÎ¹ Î·Î´Î·!',
        'Create New Forum Thread': 'Î¦Ï„Î¹Î¬Î¾Îµ Î¦Î¿ÏÎ¿Ï…Î¼ Post',
        'Create New Mail': 'Î£ÏÎ½Ï„Î±Î¾Îµ ÎœÏÎ½Î·Î¼Î±',
        Overview: 'Î•Ï€Î¹ÏƒÎºÏŒÏ€Î·ÏƒÎ·',
        Map: 'Î§Î¬ÏÏ„Î·Ï‚',
        Fetch: 'Î Î»Î·ÏÎ¿Ï†Î¿ÏÎ¯ÎµÏ‚',
        'Village data could not be fetched!':
            'Î¤Î± Î´ÎµÎ´Î¿Î¼Î­Î½Î± Ï„Î¿Ï… Ï‡Ï‰ÏÎ¹Î¿Ï Î´ÎµÎ½ Î²ÏÎ­Î¸Î·ÎºÎ±Î½!',
        Support: 'Î¥Ï€Î¿ÏƒÏ„Î®ÏÎ¹Î¾Î·',
        'OP Spotter': 'Î•Î½Ï„Î¿Ï€Î¹ÏƒÎ¼ÏŒÏ‚ Î•Ï€Î¹Î¸Î­ÏƒÎµÏ‰Î½',
        'Landing Time': 'Landing Time',
        'Own Villages Info': 'Own Villages Info',
        'Own Villages': 'Own Villages',
        'Enemy Villages': 'Enemy Villages',
    ...
    pt_PT: {
        ...
        Help: 'Ajuda',
        'It seems like you have no incomings Ã°Å¸Ëœâ‚¬': 'Sem ataques a chegar',
        ...
        'Highlight Possible Nobles': 'Destacar PossÃ­veis Nobres',
        Village: 'Aldeia',
        Count: 'Contagem',
        'Toggle Combinations': 'Ativar CombinaÃ§Ãµes',
        'Possible nobles are highlighted!': 'Possiveis Nobres Destacados',
        'No possible nobles were found!': 'NÃ£o foram encontrados nobres',
        ...
        'Last updated at:': 'Ultima AtualizaÃ§Ã£o:',
        ...
        'Current world does not support watchtower!':
            'Mundo atual nÃ£o tem torre de vigia!',
        'Watchtower Timer script is already initialized!':
            'Script da Torre de Vigia jÃ¡ foi iniciado!',
        'Create New Forum Thread': 'Criar mensagem no forum',
        'Create New Mail': 'Criar mensagem',
        Overview: 'Vista Geral',
        Map: 'Mapa',
        Fetch: 'Mostrar aldeia',
        'Village data could not be fetched!': 'Aldeia nÃ£o pode ser encontrada',
        Support: 'Apoio',
    ...
    es_ES: {
        ...
        'Last updated at:': 'Ultima ActualizaciÃ³n',
    ...
    it_IT: {
        ...
        'Watchtower Timer script is already initialized!':
            'Lo script Watchtower Timer Ã¨ giÃ  inizializzato!',
        ...
        'There was an error parsing the incomings list!': `Si Ã¨ verificato un errore durante l'analisi dell'elenco dei messaggi in entrata!`,
        ...
        'Backtime was added on incoming label!': `Backtime Ã¨ stato aggiunto all'etichetta in arrivo!`,
        'All incomings have backtime already added!':
            'Tutti gli ingressi hanno giÃ  il backtime aggiunto!',
        'Tag incomings before adding backtimes!':
...
function collectIncomingsData(incomings) {
    ...
    incomings.each((_, incoming) => {
        const isNoble = jQuery(incoming)
            .find('td:eq(0)')
            .find('img:eq(1)')
            .attr('src') && jQuery(incoming)
                .find('td:eq(0)')
                .find('img:eq(1)')
                .attr('src')
                .split('/')
...
function prepareContent(incomingsList) {
    ...
    bbCode += `[b][i][color=#ff2e2e]${tt(
        'Last updated at:'
    )}[/color] ${serverDateTime}[/i][/b]\n\n[b]${tt('Total Incomings:')}[/b] ${incomingsList.length
        }\n[b]${tt('Total Attacking Players:')}[/b] ${totalAttackingPlayers.length
        }\n[b]${tt('Attacking Players:')}[/b] ${bbPlayers}\n[b]${tt(
            'Destination Villages Count:'
        )}[/b] ${totalDestinationVillages.length}\n[b]${tt(
            'Origin Villages Count:'
        )}[/b] ${totalOriginVillages.length
        }\n\n${watchtowerInfoBBCode}\n[b][size=12]${tt('Destination Villages')} (${totalDestinationVillages.length
        })[/size][/b]\n\n[spoiler=${tt(
            ...
            ' '
        )}[/code][/spoiler]\n[b][size=12]${tt('Origin Villages')} (${totalOriginVillages.length
        })[/size][/b]\n\n[spoiler=${tt(
    ...
    return `
        <div>
            <p>
                ...
                <b>${tt('Destination Villages Count:')}</b> ${totalDestinationVillages.length
        }<br>
                <b>${tt('Origin Villages Count:')}</b> ${totalOriginVillages.length
        }<br>
                ${watchtowerInfo}<br>
            </p>
        </div>
        <div class="ra-grid ra-grid-half ra-mb14">
            <div>
                <label for="destinationVillagesCoords">
                    ${tt('Destination Villages')} (${totalDestinationVillages.length
        })
                </label>
        ...
        if (duplicateAttacks.length) {
            ...
            for (let [_, value] of Object.entries(
                ...
                value.forEach((item, index) => {
                    ...
                    const newCommandName = `${nameOfIncomingCommand} AS:${index + 1
                        }/${value.length}`;
            ...
            finalArray.forEach((item, index) => {
                setTimeout(function () {
                    ...
                    jQuery('span.quickedit[data-id="' + id + '"]')
                        ...
                        .click();
                    UI.InfoMessage(`${index}/${finalArray.length} ${tt('Renaming ...')}`);
                }, 160 * index);
            });
        } else {
...
(async function () {
    ...
    if (!parseInt(game_data.player.incomings)) {
        if (jQuery('#incomings_table tbody tr.nowrap').length === 0) {
            UI.SuccessMessage(tt('It seems like you have no incomings ðŸ˜€'));
            return;
        }
    }
